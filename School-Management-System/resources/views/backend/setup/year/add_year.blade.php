            ...
            <div class="col-lg-12">
                ...
                <div class="card">
                    <div class="card-header">
                        <h5 class="card-title">Create New Year</h5>
                    </div>

                    <div class="card-body">
                        <form id="editSettings"  class="form-validate-jquery main_form">
                            @csrf
                            <legend class="font-weight-semibold" >Enter Year </legend>
        ...
        $('#save-form').click(function () {
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    window.location.replace('/setups/student/year/view');
