...
@section('admin')
    ...
    <a href="{{route('student.fee_category.add')}}" class="btn btn-dark btn-sm m-l-15"><i
    ...
    <script>
        ...
        $( document ).ready(function() {
            ...
            let table=    $('#myTable').DataTable({
                processing: true,
                serverSide: true,
                ajax: '{!! route('student.fee_category.view') !!}',
                columns: [
                    {data: 'id', name: 'id'},
                    {data: 'name', name: 'name'},
            ...
            $('body').on('click', '.delete_fee_category', function () {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        var url = "{{ route('student.fee_category.delete', ':id') }}";
