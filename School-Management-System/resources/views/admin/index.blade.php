                        ...
                        <div class="row">
                            <div class="col-sm-4">
                                <div class="d-flex align-items-center justify-content-center mb-2">
                                    <a href="#"
                                       class="btn bg-transparent border-teal text-teal rounded-pill border-2 btn-icon mr-3">
                            ...
                            <tr>
                                <td>
                                    <div class="d-flex align-items-center">
                                        <div class="mr-3">
                                            <a href="#">
                                                <img src="{{asset('global_assets/images/brands/facebook.svg')}}"
                                ...
                                <td><span class="text-success"><i
                                            class="icon-stats-growth2 mr-2"></i> 2.43%</span></td>
                            ...
                            <tr>
                                <td>
                                    <div class="d-flex align-items-center">
                                        <div class="mr-3">
                                            <a href="#">
                                                <img src="{{asset('global_assets/images/brands/youtube.svg')}}"
                                                     class="rounded-circle" width="32" height="32" alt="">
                                            </a>
                                        </div>
                                        <div>
                                            <a href="#" class="text-body font-weight-semibold">Youtube
                                                videos</a>
                                            <div class="text-muted font-size-sm">
                                ...
                                <td><span class="text-success"><i
                                            class="icon-stats-growth2 mr-2"></i> 3.12%</span></td>
                            ...
                            <tr>
                                <td>
                                    <div class="d-flex align-items-center">
                                        <div class="mr-3">
                                            <a href="#">
                                                <img src="{{asset('global_assets/images/brands/spotify.svg')}}"
                                                     class="rounded-circle" width="32" height="32" alt="">
                                            </a>
                                        </div>
                                        <div>
                                ...
                                <td><span class="text-danger"><i
                                            class="icon-stats-decline2 mr-2"></i> - 8.02%</span></td>
                            ...
                            <tr>
                                <td>
                                    <div class="d-flex align-items-center">
                                        <div class="mr-3">
                                            <a href="#">
                                                <img src="{{asset('global_assets/images/brands/twitter.svg')}}"
                                                     class="rounded-circle" width="32" height="32" alt="">
                                            </a>
                                        </div>
                                        <div>
                                ...
                                <td><span class="text-success"><i
                                            class="icon-stats-growth2 mr-2"></i> 2.78%</span></td>
                            ...
                            <tr>
                                <td>
                                    <div class="d-flex align-items-center">
                                        <div class="mr-3">
                                            <a href="#">
                                                <img src="{{asset('global_assets/images/brands/bing.svg')}}"
                                                     class="rounded-circle" width="32" height="32" alt="">
                                            </a>
                                        </div>
                                        <div>
                                ...
                                <td><span class="text-danger"><i
                                            class="icon-stats-decline2 mr-2"></i> - 5.78%</span></td>
                            ...
                            <tr>
                                <td>
                                    <div class="d-flex align-items-center">
                                        <div class="mr-3">
                                            <a href="#">
                                                <img src="{{asset('global_assets/images/brands/amazon.svg')}}"
                                                     class="rounded-circle" width="32" height="32" alt="">
                                            </a>
                                        </div>
                                        <div>
                                ...
                                <td><span class="text-success"><i
                                            class="icon-stats-growth2 mr-2"></i> 6.79%</span></td>
                            ...
                            <tr>
                                <td>
                                    <div class="d-flex align-items-center">
                                        <div class="mr-3">
                                            <a href="#">
                                                <img src="{{asset('global_assets/images/brands/dribbble.svg')}}"
                                                     class="rounded-circle" width="32" height="32" alt="">
                                            </a>
                                        </div>
                                        <div>
                                ...
                                <td><span class="text-danger"><i
                                            class="icon-stats-decline2 mr-2"></i> 9.83%</span></td>
                    ...
                    <div class="table-responsive">
                        <table class="table text-nowrap">
                                    ...
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div>
                                            ...
                                            <div class="text-muted font-size-sm"><span
                                                    class="badge badge-mark border-primary mr-1"></span> Active
                                            </div>
                                        </div>
                                    </div>
                                </td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div>
                                            <a href="#" class="text-body font-weight-semibold">Chris
                                                Macintyre</a>
                                            <div class="text-muted font-size-sm"><span
                                                    class="badge badge-mark border-primary mr-1"></span> Active
                                            </div>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="#" class="text-body">
                                        <div class="font-weight-semibold">[#1254] Inaccurate small pagination
                                            height
                                        </div>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div>
                                            <a href="#" class="text-body font-weight-semibold">Roxanne
                                                Forbes</a>
                                            <div class="text-muted font-size-sm"><span
                                                    class="badge badge-mark border-success mr-1"></span>
                                                Resolved
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div>
                                            <a href="#" class="text-body font-weight-semibold">Mitchell
                                                Sitkin</a>
                                            <div class="text-muted font-size-sm"><span
                                                    class="badge badge-mark border-danger mr-1"></span> Closed
                                            </div>
                                        </div>
                                    </div>
                                </td>
                                        ...
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-right">
                                                ...
                                                <a href="#" class="dropdown-item"><i
                                                        class="icon-plus3 text-primary"></i> Unresolve issue</a>
                                                <a href="#" class="dropdown-item"><i
                                                        class="icon-spinner11 text-success"></i> Reopen
                                                    issue</a>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="#" class="text-body">
                                        <div>[#1038] Proper sizing of form control feedbgack</div>
                            ...
                            <tr>
                                <td>
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div>
                                            <a href="#"
                                               class="text-body font-weight-semibold letter-icon-title">Sigma
                                                application</a>
                            ...
                            <tr>
                                <td>
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div>
                                            <a href="#"
                                               class="text-body font-weight-semibold letter-icon-title">Alpha
                                                application</a>
                                            <div class="text-muted font-size-sm"><i
                            ...
                            <tr>
                                <td>
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div>
                                            <a href="#"
                                               class="text-body font-weight-semibold letter-icon-title">Delta
                                                application</a>
                                            <div class="text-muted font-size-sm"><i
                            ...
                            <tr>
                                <td>
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div>
                                            <a href="#"
                                               class="text-body font-weight-semibold letter-icon-title">Omega
                                                application</a>
                                            <div class="text-muted font-size-sm"><i
                                                    class="icon-lifebuoy font-size-sm mr-1"></i> Support
                                            </div>
